...
# family_rules.
family_rules =[
                IF( OR('male (?a)','female (?a)'), THEN('same-identity (?a) (?a)')), 
                IF( AND('parent (?a) (?b)','parent (?a) (?c)','male (?b)',NOT('same-identity (?b) (?c)')), THEN('brother (?b) (?c)')),
                IF( AND('parent (?a) (?b)','parent (?a) (?c)','female (?b)',NOT('same-identity (?b) (?c)')), THEN('sister (?b) (?c)')),
                IF( AND('parent (?a) (?b)','male (?a)'), THEN('father (?a) (?b)')),
                IF( AND('parent (?a) (?b)','female (?a)'), THEN('mother (?a) (?b)')),
                IF( AND('parent (?a) (?b)','male (?b)'), THEN('son (?b) (?a)')),
                IF( AND('parent (?a) (?b)','female (?b)'), THEN('daughter (?b) (?a)')),
                IF( AND('parent (?a) (?b)','parent (?c) (?d)',OR('brother (?a) (?c)','sister (?a) (?c)')), THEN('cousin (?b) (?d)','cousin (?d) (?b)')),
                IF( AND('parent (?a) (?b)','parent (?b) (?c),'), THEN('grandparent (?a) (?c)','grandchild (?c) (?a)')),
                 ]                   
...
WHAT_I_FOUND_BORING = 'forward chaining'

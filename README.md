# MIT-OCW-6.034-Artificial-Intelligence-Fall-2010

[![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC%20BY--NC--SA%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0/)

![logo](./logo.jpg)

My coursework for MIT OCW 6.034 Artificial Intelligence Fall 2010 class.

All solutions are my own.

This coursework only includes the coding assignments. Among the 9 MIT coursework repositories on my GitHub, this is the only one that is incomplete. This was intentional, as the field has advanced significantly since 2010.
...
| Topic | Subtopics |
|-------|-----------|
| Reasoning | Goal trees, problem solving, rule-based expert systems |
| Search | Depth-first, hill climbing, beam search, branch and bound, A*, minimax, alpha-beta pruning |
| Constraints | Interpreting line drawings, domain reduction, visual object recognition |
| Learning | Nearest neighbors, identification trees, neural nets, back propagation, genetic algorithms, SVMs, boosting |

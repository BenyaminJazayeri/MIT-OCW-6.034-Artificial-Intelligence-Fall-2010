...
def focused_evaluate(board):
    ...
    return  250 * (board.longest_chain(current_player_id)-
                   board.longest_chain(other_player_id))
...
def alpha_beta_search(board, depth,
    ...
    def minimax_find_board_value(board, depth, alpha, beta):
        """
        ...
        for move, new_board in get_next_moves_fn(board):
            val = -1 * minimax_find_board_value(new_board, depth-1, beta,alpha)
    ...
    for move, new_board in get_next_moves_fn(board):
        val = -1 * minimax_find_board_value(new_board, depth-1, alpha, beta)
...
your_playermm = lambda board: minimax(board, depth=4,
                                              eval_fn=better_evaluate)
...
WHAT_I_FOUND_INTERESTING = "the coding of the tutorial"
WHAT_I_FOUND_BORING = "the fact that the first step should be minimizer"
NAME = "Benyamin Jazayeri"
EMAIL = "benyamin.jazayeri@yahoo.com"
